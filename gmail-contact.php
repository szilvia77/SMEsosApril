...
$sendToEmail = 'sme.sos.uk@gmail.com';
$sendToName = 'SME-sos';
...
// If something goes wrong, it will display this message.
...
try {
    ...
    $emailTextHtml .= "<h3>New message from smesos:</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>SME-sos TEAM</p>";
...
//************** IMPORTANT
    ...
    $mail->Username = "sme.sos.uk@gmail.com";
    $mail->Password = "smesos2020!";
